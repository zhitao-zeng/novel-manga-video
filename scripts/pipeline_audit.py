...
JUDGE_PROMPT = (
    ...
    "交代这个地方常态时段与主光源的句子不算临时状态：「傍晚，天光将暗，路灯刚亮」写的是这里每天傍晚的样子，填 false。\n"
    "4. states_time：读完这段，画图的人知不知道该把这里画成什么时候？直接写了「下午」「夜里」算知道，"
    "写「阳光直射」「车窗透进日光」这种能推出白天的也算知道。"
    "室内且照明恒定的地方（商场、地下室、没有窗的房间），写明了人工光源就算交代清楚，填 true；"
    "完全看不出才填 false。\n"
