...
OUTLINE_SECTIONS = {
    "coverage": {
        ...
        "retained_dialogue": "保留的关键原文台词，以及承载叙述事实的合理对白或动作。最多挑 8 条最重要的（转场问答、动机交代、笑点收尾优先；章节台词预算有限，全列等于没列）。关键问答成对保留（提问和回答或画面回答，不只剩一半）；角色的动机、决定这类观众必须知道的信息，注明由哪句台词、内心独白或动作交代。",
