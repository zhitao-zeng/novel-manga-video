...
from novel_manga.application.repair.publication import publish_candidate, publish_source_review
...
def prepare_source_recheck(directory: Path, targets: list[str] | None = None, *, instructions: dict | None = None) -> dict:
    ...
    from novel_manga.application.planning.context import load_entity_index, ledger_cast
    from novel_manga.planning.cast import mentioned_characters
    from novel_manga.application.repair.judges import speaker_contract
