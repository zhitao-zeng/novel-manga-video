...
import novel_manga.application.identity.phases as thin_phases
from novel_manga.application.identity.context import prompt_block as identity_prompt_block
import os
import re
import subprocess
...
from novel_manga.application.profiles import load_genre, load_profile
...
def snapshot_block(clip: dict, episode_dir: Path) -> str:
    ...
    try:
        ...
        from novel_manga.application.identity.ledger_views import snapshot
