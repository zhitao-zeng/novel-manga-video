...
def repair_missing_expressions(directory: Path) -> dict:
    ...
    from novel_manga.application.repair.history import accepted_clip_material, begin_trial, load, save, refresh_prepared_plan, ERROR_FIELDS
    ...
    from novel_manga.application.preparation.readiness import inspect_episode, save_check
